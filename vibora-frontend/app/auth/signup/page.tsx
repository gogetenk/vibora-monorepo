...
export default function SignupPage() {
  ...
  const [skillLevel, setSkillLevel] = useState(5) // 1-10 scale, default: 5 (Intermediate)
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Compte créé !",
        description: "Bienvenue sur Vibora ! Vous pouvez maintenant créer des parties.",
      })
        ...
        >
          <VContentCard variant="elevated">
            <CardHeader className="space-y-1 text-center">
              ...
              <CardDescription>
                Rejoignez Vibora pour organiser vos parties de padel
              </CardDescription>
            </CardHeader>
              ...
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-medium text-primary">{skillLevel}/10</span>
                  </div>
                  <Slider
                    id="skillLevel"
                    min={1}
                  ...
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <span>🌱 Débutant (1-3)</span>
                    <span>⭐ Intermédiaire (4-7)</span>
                    <span>🏆 Avancé (8-10)</span>
                  </div>
                </div>
